...
export const King = memo(({ color, className = '' }: PieceProps) => (
  <svg viewBox="0 0 45 45" className={className}>
    {color === 'white' ? (
      ...
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
        ...
        <path fill="#000" stroke="#000" d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10 5 10V37z"/>
        <path stroke="#fff" d="M20 8h5"/>
        <path stroke="#fff" d="M32 29.5s8.5-4 6.03-9.65C34.15 14 25 18 22.5 24.5l.01 2.1-.01-2.1C20 18 9.906 14 6.997 19.85c-2.497 5.65 4.853 9 4.853 9"/>
...
export const Queen = memo(({ color, className = '' }: PieceProps) => (
  <svg viewBox="0 0 45 45" className={className}>
    {color === 'white' ? (
      <g fill="#fff" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
        <path d="M8 12a2 2 0 1 1-4 0 2 2 0 1 1 4 0zm16.5-4.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0zm17 4.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM9 26c8.5-1.5 21-1.5 27 0l2.5-12.5L31 25l-.3-14.1-5.2 13.6-3-14.5-3 14.5-5.2-13.6L14 25 6.5 13.5 9 26zm-1 12.5c3.5-1 18.5-1 24 0 0 0 1.5-1 0-2.5-1.5-1-16.5-1-24 0-1.5 1.5 0 2.5 0 2.5z"/>
        <path fill="none" d="M9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 .5 3.5-1.5 1-1.5 2.5-1.5 2.5-1.5 1.5.5 2.5.5 2.5 6.5 1 16.5 1 23 0 0 0 1.5-1 0-2.5 0 0 .5-1.5-1-2.5-.5-2.5-.5-2 .5-3.5 1-2 2.5-2 2.5-4-8.5-1.5-18.5-1.5-27 0z"/>
        <path fill="none" strokeLinecap="butt" d="M11.5 30c3.5-1 18.5-1 24 0M12 33.5c6-1 15-1 21 0"/>
      </g>
    ) : (
      <g fill="#000" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
        ...
        <path fill="none" stroke="#fff" d="M11.5 30c3.5-1 18.5-1 24 0m-24.5 3.5c6-1 15-1 21 0"/>
        <path fill="none" stroke="#fff" d="M12 33.5c6-1 15-1 21 0"/>
      </g>
    )}
  </svg>
));

export const Rook = memo(({ color, className = '' }: PieceProps) => (
  <svg viewBox="0 0 45 45" className={className}>
    {color === 'white' ? (
      <g fill="#fff" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
      ...
      <g fill="#000" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
        <path strokeLinecap="butt" d="M9 39h27v-3H9v3zm3.5-7l1.5-2.5h17l1.5 2.5h-20zm-.5 4v-4h21v4H12z"/>
        <path strokeLinecap="butt" strokeLinejoin="miter" d="M14 29.5v-13h17v13H14z"/>
        <path d="M14 16.5L11 14h23l-3 2.5H14z"/>
        <path strokeLinecap="butt" strokeLinejoin="miter" d="M11 14V9h4v2h5V9h5v2h5V9h4v5H11z"/>
        <path fill="none" stroke="#fff" strokeLinejoin="miter" strokeWidth="1" d="M12 35.5h21m-20-4h19m-18-2h17m-17-13h17M11 14h23"/>
      </g>
    )}
  </svg>
));

export const Bishop = memo(({ color, className = '' }: PieceProps) => (
  <svg viewBox="0 0 45 45" className={className}>
    {color === 'white' ? (
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export const Knight = memo(({ color, className = '' }: PieceProps) => (
  <svg viewBox="0 0 45 45" className={className}>
    {color === 'white' ? (
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
      ...
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
        ...
        <path fill="#fff" d="M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0zm5.433-9.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z"/>
        <path fill="none" stroke="#fff" d="M24.55 10.4l-.45 1.45.5.15c3.15 1 5.65 2.49 7.9 6.75S35.75 29.06 35.25 39l-.05.5h2.25l.05-.5c.5-10.06-.88-16.85-3.25-21.34-2.37-4.49-5.79-6.64-9.19-7.16l-.51-.1z"/>
      </g>
    )}
  </svg>
));

export const Pawn = memo(({ color, className = '' }: PieceProps) => (
  <svg viewBox="0 0 45 45" className={className}>
    {color === 'white' ? (
      <path
        fill="#fff"
