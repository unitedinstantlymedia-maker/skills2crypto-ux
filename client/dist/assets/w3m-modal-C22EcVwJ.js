import{dw as x,dS as te,cM as c,cO as ne,cx as g,cy as j,cB as m,cC as b,cD as d,cA as l,db as k,cX as z,dc as u,cz as se,cT as f,cF as D,d9 as L,dM as le,dC as V,cQ as U,di as R,c$ as F,cI as ce,cN as A,dy as T,dJ as q,da as de,cH as ie,dT as ue,dU as he}from"./index-D9FWafG6.js";import{P as _}from"./index-Bpm0tjLe.js";import{S as pe}from"./SwapController-BlbM4eSJ.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
