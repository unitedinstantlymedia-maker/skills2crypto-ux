import{cr as L,cu as k,d6 as l,cv as I,cw as O,cV as E,de as h,du as W,cG as f,cT as T,cx as c,dv as F,cP as v,dw as D,cR as N,dx as R,d5 as $,cN as d,cI as P,dy as j,cK as u,dz as A,cH as C,dA as M,ds as _,d4 as y}from"./index-C94xOU6C.js";const z=L`
  :host {
...
`;var U=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let S=class extends O{constructor(){super(),this.unsubscribe=[],this.checked=R.state.isLegalCheckboxChecked,this.unsubscribe.push(R.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:i}=h.state,r=h.state.features?.legalCheckbox,n=!!(e||i)&&!!r&&!this.checked,a=n?-1:void 0;return c`
    ...
    `}};S.styles=q;U([l()],S.prototype,"checked",void 0);S=U([I("w3m-connect-socials-view")],S);const G=L`
  wui-logo {
    width: 80px;
    height: 80px;
